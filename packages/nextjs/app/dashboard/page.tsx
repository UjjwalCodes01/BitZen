      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-[var(--text-secondary)]">
            {isConnected ? `Welcome back, Agent` : 'Connect your wallet to get started'}
          </p>
        </div>
        ...
        {!isConnected ? (
          ...
          <div className="card text-center py-16">
            ...
            <p className="text-[var(--text-secondary)] mb-8 max-w-md mx-auto">
              Connect your Starknet wallet to access your agent dashboard and manage your autonomous operations.
            </p>
          </div>
        ) : (
          <>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="card border-2 border-[var(--accent-purple)]/30">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-sm text-[var(--text-secondary)] mb-1">AGENT STATUS</h3>
                    {primaryAgent ? (
                      <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-full bg-[var(--success)] agent-live"></div>
                        <span className="text-xl font-bold text-[var(--success)]">ACTIVE</span>
                      </div>
                    ) : (
                      <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-full bg-[var(--text-muted)]"></div>
                        <span className="text-xl font-bold text-[var(--text-muted)]">NOT REGISTERED</span>
                      </div>
                    )}
                  </div>
                  <ShieldCheckIcon className={`w-12 h-12 ${primaryAgent ? 'text-[var(--success)]' : 'text-[var(--text-muted)]'}`} />
                </div>
                ...
                {primaryAgent ? (
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-semibold">{sessionsCount} active</span>
                    </div>
                  </div>
                ) : (
                  <Link href="/agents/register" className="btn-primary w-full text-center mt-4 inline-flex items-center justify-center gap-2">
              ...
              <div className="card border-2 border-[var(--accent-purple)]/30">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-sm text-[var(--text-secondary)] mb-1">STARKNET BALANCE</h3>
                    <div className="text-2xl font-bold text-[var(--accent-purple)]">{strkBalance} STRK</div>
                  </div>
                  <div className="w-12 h-12 rounded-full gradient-purple flex items-center justify-center">
                    <BoltIcon className="w-6 h-6 text-white" />
                  </div>
                </div>
                <Link href="/swap" className="text-sm text-[var(--accent-purple)] hover:underline inline-flex items-center gap-1">
              ...
              <div className="card border-2 border-[var(--accent-orange)]/30">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-sm text-[var(--text-secondary)] mb-1">BITCOIN BALANCE</h3>
                    <div className="text-2xl font-bold text-[var(--accent-orange)]">{btcBalance} BTC</div>
                  </div>
                  <div className="w-12 h-12 rounded-full gradient-orange flex items-center justify-center">
                    <CurrencyDollarIcon className="w-6 h-6 text-white" />
                  </div>
                </div>
                <Link href="/swap" className="text-sm text-[var(--accent-orange)] hover:underline inline-flex items-center gap-1">
              ...
              <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="card">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between py-2 border-b border-[var(--border-color)]">
                        <span className="text-[var(--text-secondary)]">Agent Address:</span>
                      ...
                      <div className="flex justify-between py-2 border-b border-[var(--border-color)]">
                        <span className="text-[var(--text-secondary)]">Registration Date:</span>
                        <span>Jan 15, 2026</span>
                      </div>
                      <div className="flex justify-between py-2">
                        <span className="text-[var(--text-secondary)]">ZK Proof Status:</span>
                ...
                <div className="card">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Link href="/activity" className="text-sm text-[var(--accent-purple)] hover:underline">
                      View All
                    </Link>
                  </div>
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-[var(--text-secondary)]">{activity.description}</div>
                          </div>
                        </div>
              ...
              <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex justify-between mb-2">
                        <span className="text-sm text-[var(--text-secondary)]">Services Used</span>
                        <span className="font-bold text-[var(--accent-purple)]">8</span>
                      </div>
                      <div className="w-full bg-[var(--bg-dark)] rounded-full h-2">
                        <div className="bg-[var(--accent-purple)] h-2 rounded-full" style={{ width: '80%' }}></div>
                      </div>
                    </div>

                    <div>
                      <div className="flex justify-between mb-2">
                        <span className="text-sm text-[var(--text-secondary)]">Reviews Given</span>
                        <span className="font-bold text-[var(--accent-orange)]">12</span>
                      </div>
                      <div className="w-full bg-[var(--bg-dark)] rounded-full h-2">
                        <div className="bg-[var(--accent-orange)] h-2 rounded-full" style={{ width: '60%' }}></div>
                      </div>
                    </div>

                    <div>
                      <div className="flex justify-between mb-2">
                        <span className="text-sm text-[var(--text-secondary)]">Auditor Stakes</span>
                        <span className="font-bold text-[var(--success)]">5</span>
                      </div>
                      <div className="w-full bg-[var(--bg-dark)] rounded-full h-2">
                    ...
                    <div className="pt-4 border-t border-[var(--border-color)]">
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-[var(--text-secondary)]">Reputation Score</span>
                        <span className="text-2xl font-bold text-[var(--accent-purple)]">87/100</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="card">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Link href="/sessions" className="text-sm text-[var(--accent-purple)] hover:underline">
                      Manage
                    </Link>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="p-3 rounded-xl bg-[var(--bg-hover)] border border-[var(--accent-purple)]/30">
                      ...
                      <div className="flex justify-between text-xs">
                        <span className="text-[var(--text-secondary)]">Expires in 12 days</span>
                    ...
                    <div className="p-3 rounded-xl bg-[var(--bg-hover)] border border-[var(--accent-purple)]/30">
                      ...
                      <div className="flex justify-between text-xs">
                        <span className="text-[var(--text-secondary)]">Expires in 25 days</span>
                        <span className="text-[var(--success)]">Active</span>
                      </div>
                    </div>
                    ...
                    <div className="p-3 rounded-xl bg-[var(--bg-hover)] border border-[var(--accent-purple)]/30">
                      ...
                      <div className="flex justify-between text-xs">
                        <span className="text-[var(--text-secondary)]">Expires in 3 days</span>
                        <span className="text-[var(--warning)]">Expiring Soon</span>
                      </div>
                    </div>
                  </div>

                  <Link href="/sessions" className="btn-outline w-full mt-4 text-center inline-flex items-center justify-center gap-2">
