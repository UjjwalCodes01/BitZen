      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <div className="w-8 h-8 rounded-lg gradient-purple flex items-center justify-center font-bold">
                BZ
              </div>
              <span className="text-lg font-bold text-[var(--text-primary)]">BitZen</span>
            </div>
            <p className="text-[var(--text-secondary)] text-sm">
              The first AI agent marketplace on Starknet. Autonomous, private, and powered by
              Bitcoin.
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-[var(--border-color)] flex flex-col md:flex-row justify-between items-center">
          <p className="text-[var(--text-muted)] text-sm">
            © 2026 BitZen. Built for RE{'{'}DEFINE{'}'} Hackathon.
          </p>
          <div className="flex items-center space-x-4 mt-4 md:mt-0">
            <span className="text-xs text-[var(--text-muted)]">Powered by</span>
            <div className="flex items-center space-x-3">
              <span className="badge-purple text-xs">Starknet</span>
              <span className="badge-orange text-xs">Bitcoin</span>
              <span className="badge-purple text-xs">Garaga</span>
            </div>
          </div>
        </div>
      </div>
