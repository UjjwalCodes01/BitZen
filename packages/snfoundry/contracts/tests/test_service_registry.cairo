...
fn test_register_service() {
    ...
    let success = dispatcher.register_service(service_name, service_description, service_endpoint, stake_amount);
...
fn test_get_service() {
    ...
    let (provider, name, description, total_stake, created_at, is_active) = dispatcher.get_service(service_id);
