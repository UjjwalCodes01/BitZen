...
#[starknet::contract]
mod TestZKPassport {
    use starknet::{ContractAddress, get_caller_address, get_block_number, ClassHash};
    use starknet::storage::{StoragePointerReadAccess, StoragePointerWriteAccess, StoragePathEntry, Map};
    use core::num::traits::Zero;
    use contracts::MockGaragaVerifier::{IMockGaragaVerifierDispatcher, IMockGaragaVerifierDispatcherTrait};
    ...
    impl TestZKPassportImpl of contracts::ZKPassport::IZKPassport<ContractState> {
        fn register_agent(
            ...
            self.agents.entry(agent_address).write(
                AgentCredential {
                    agent_address,
                    is_verified: true,
